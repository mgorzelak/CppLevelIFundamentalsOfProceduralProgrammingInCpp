...
int main()
{
    ...
    cout << "numbersOfNeuronInHumanBrain: " << numbersOfNeuronInHumanBrain<< endl;
    cout <<" number PI: "<< numberPi<< endl;
    cout << " numbersOfFacebookMembers: " << numbersOfFacebookMembers<< "members" << endl;
